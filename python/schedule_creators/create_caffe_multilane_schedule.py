...
def main(rootdir, batchsize, exclude_list):
    ...
    for root, subfolders, files in os.walk(rootdir):
        ...
        if  ('4-10-14' not in root) and ('7-25-14' not in root): # used for testing now.
          for f in files:
    ...
    fid = open('/scail/group/deeplearning/driving_data/twangcat/schedules/q50_multilane_planar_train_schedule1_batch'+str(batchsize)+'_2cam.txt', 'w')
    for s in schedule:
