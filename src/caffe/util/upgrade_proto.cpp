...
V1LayerParameter_LayerType UpgradeV0LayerType(const string& type) {
  if (type == "accuracy") {
    ...
    return V1LayerParameter_LayerType_DRIVING_DATA;
...
bool UpgradeV1LayerParameter(const V1LayerParameter& v1_layer_param,
  ...
  if (v1_layer_param.has_tiling_param()) {
    layer_param->mutable_tiling_param()->CopyFrom(
        v1_layer_param.tiling_param());
  }
...
const char* UpgradeV1LayerType(const V1LayerParameter_LayerType type) {
  ...
  case V1LayerParameter_LayerType_DATA:
    return "Data";
  case V1LayerParameter_LayerType_DRIVING_DATA:
    return "DrivingData";
  ...
  case V1LayerParameter_LayerType_LRN:
    return "LRN";
  case V1LayerParameter_LayerType_LRNK:
    return "LRNK";
